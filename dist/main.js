...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n\n\nasync function fetchWeather(location = 'manila') {\n    try {\n        const url = `https://api.weatherapi.com/v1/current.json?key=721c875483c04df38db200139230306&q=${location}&aqi=yes`\n        const response = await fetch(url, { mode: 'cors' });\n        if (!response.ok) {\n            _dom__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errorMessage('Location not found. Search must be in the form of \"City\", \"City, State\" or \"City, Country\".')\n            return null\n        }\n        const weatherData = await response.json();\n        return weatherData\n    } catch (error) {\n        _dom__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errorMessage(error)\n        return null\n    } \n}\n\nfunction getWeatherData(location) {\n    fetchWeather(location)\n    .then(response => {\n        if (response.error) {\n            _dom__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errorMessage(response.error.message);\n        } else {\n            _dom__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errorMessage()\n            _dom__WEBPACK_IMPORTED_MODULE_0__[\"default\"].showWeatherData(response)\n        }\n    })\n}\n\nfunction searchLocationWeather() {\n    const location = document.querySelector('#searchForm');\n    location.addEventListener('submit', function(e) {\n        e.preventDefault();\n        const input = document.querySelector('#locationInput');\n        if (input.value === '') return\n        getWeatherData(input.value)\n        this.reset()\n    }) \n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n    getWeatherData,\n    searchLocationWeather\n});\n\n//# sourceURL=webpack://weather-app/./src/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app */ \"./src/app.js\");\n\n\n\nwindow.addEventListener('DOMContentLoaded', function() {\n    _app__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getWeatherData()\n    _app__WEBPACK_IMPORTED_MODULE_1__[\"default\"].searchLocationWeather()\n})\n\n\n//# sourceURL=webpack://weather-app/./src/index.js?");
